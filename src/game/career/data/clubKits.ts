...
const KITS: Record<string, KitScheme> = {
  ...
  lyon: { primary: '#FFFFFF', shorts: '#FFFFFF', socks: '#FFFFFF', pattern: 'solid' },
  valencia: { primary: '#FFFFFF', shorts: '#000000', socks: '#FFFFFF', pattern: 'solid' },
  brentford: { primary: '#E30613', secondary: '#FFFFFF', pattern: 'vertical', shorts: '#000000', socks: '#E30613' },
  bournemouth: { primary: '#DA291C', secondary: '#FFFFFF', pattern: 'vertical', shorts: '#000000', socks: '#000000' },
  ...
  psg: { primary: '#DA001C', secondary: '#004170', pattern: 'solid', shorts: '#004170', socks: '#004170', sleeves: '#004170' },
  ...
  arsenal: { primary: '#EF0107', secondary: '#FFFFFF', pattern: 'solid', shorts: '#FFFFFF', socks: '#FFFFFF', sleeves: '#FFFFFF' },
  sunderland: { primary: '#FFFFFF', secondary: '#EB172B', pattern: 'vertical', shorts: '#111111', socks: '#111111' },
  burnley: { primary: '#6C1D45', secondary: '#99D6EA', pattern: 'solid', shorts: '#6C1D45', socks: '#6C1D45', sleeves: '#99D6EA' },
  brighton: { primary: '#FFFFFF', secondary: '#0057B8', pattern: 'vertical', shorts: '#0057B8', socks: '#0057B8' },
  napoli: { primary: '#12A0D7', shorts: '#FFFFFF', socks: '#12A0D7' },
  'crystal-palace': { primary: '#C4122E', secondary: '#1B458F', pattern: 'vertical', shorts: '#1B458F', socks: '#1B458F' },
  'aston-villa': { primary: '#5D0F2E', secondary: '#95BFE5', pattern: 'solid', shorts: '#FFFFFF', socks: '#95BFE5' },
  'celta-vigo': { primary: '#8AC3EE', shorts: '#FFFFFF', socks: '#8AC3EE' },
  girona: { primary: '#E30613', secondary: '#FFFFFF', pattern: 'vertical', shorts: '#E30613', socks: '#E30613' },
  'real-sociedad': { primary: '#FFFFFF', secondary: '#0A3F87', pattern: 'vertical', shorts: '#0A3F87', socks: '#0A3F87' },
  rayo: { primary: '#FFFFFF', secondary: '#E30613', pattern: 'solid', shorts: '#FFFFFF', socks: '#FFFFFF', sleeves: '#E30613' },
  mallorca: { primary: '#E20613', shorts: '#111111', socks: '#111111' },
  cadiz: { primary: '#FDE100', shorts: '#0033A0', socks: '#0033A0' },
  villarreal: { primary: '#FFE667', shorts: '#FFE667', socks: '#FFE667' },
  sevilla: { primary: '#FFFFFF', shorts: '#FFFFFF', socks: '#000000' },
